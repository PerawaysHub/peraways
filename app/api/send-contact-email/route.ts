...
Bei dringenden Fragen erreichen Sie uns unter info@peraways.de.
...
For urgent matters, please contact us at info@peraways.de.

Best regards,
Your PeraWays Team`;

    const { error } = await resend.emails.send({
      from: "PeraWays <info@peraways.de>",
      replyTo: "info@peraways.de",
      to: email,
      subject,
      text: body,
    });
