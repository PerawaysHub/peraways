...
const iconsDE = [
  ...
  { icon: Home, title: "Wohnung inklusive", desc: "Wir arbeiten mit Arbeitgebern, die Wohnungen anbieten.", detail: "Wohnraum ist der kritische Erfolgsfaktor für die Visumserteilung. Durch die Bereitstellung einer Unterkunft wird die mathematische Lebensunterhaltssicherung gemäß § 2 Abs. 3 AufenthG rechtssicher garantiert. Wir arbeiten daher exklusiv mit Partnern zusammen, die dieses wichtige Fundament für ihre neuen Fachkräfte legen können." },
];
